<?php
namespace PlayerxCore\CPT\Shortcodes\ProductInfo;
...
class ProductInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if(function_exists('vc_map')) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product Info', 'playerx' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Product', 'playerx' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
						...
						array(
							...
							'heading'     => esc_html__( 'Product Info Type', 'playerx' ),
							'value'       => array(
								esc_html__( 'Title', 'playerx' )          => 'title',
								esc_html__( 'Featured Image', 'playerx' ) => 'featured_image',
								esc_html__( 'Category', 'playerx' )       => 'category',
								esc_html__( 'Excerpt', 'playerx' )        => 'excerpt',
								esc_html__( 'Price', 'playerx' )          => 'price',
								esc_html__( 'Rating', 'playerx' )         => 'rating',
								esc_html__( 'Add To Cart', 'playerx' )    => 'add_to_cart',
								esc_html__( 'Tag', 'playerx' )            => 'tag',
								esc_html__( 'Author', 'playerx' )         => 'author',
								esc_html__( 'Date', 'playerx' )           => 'date',
							),
							'admin_label' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Product Info Color', 'playerx' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Featured Image Proportions', 'playerx' ),
							'value'      => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Category Tag', 'playerx' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Add To Cart Skin', 'playerx' ),
							'value'      => array(
								esc_html__( 'Default', 'playerx' ) => '',
								esc_html__( 'White', 'playerx' )   => 'white',
						...
						array(
							...
							'heading'    => esc_html__( 'Add To Cart Size', 'playerx' ),
							'value'      => array(
								esc_html__( 'Default', 'playerx' ) => '',
							...
							'dependency' => array( 'element' => 'product_info_type', 'value'   => array( 'playerx' ) ),
							'group'      => esc_html__( 'Product Info Style', 'playerx' )
						)
					)
				)
	...
	public function productIdAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				$data = array();
				$data['value'] = $value['id'];
				$data['label'] = esc_html__( 'Id', 'playerx' ) . ': ' . $value['id'] . ( ( strlen( $value['title'] ) > 0 ) ? ' - ' . esc_html__( 'Title', 'playerx' ) . ': ' . $value['title'] : '' );
				$results[] = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( ! is_wp_error( $product ) ) {
				...
				if ( ! empty( $product_title ) ) {
					$product_title_display = ' - ' . esc_html__( 'Title', 'playerx' ) . ': ' . $product_title;
				}
				
				$product_id_display = esc_html__( 'Id', 'playerx' ) . ': ' . $product_id;

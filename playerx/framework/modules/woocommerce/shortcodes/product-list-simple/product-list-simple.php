...
namespace PlayerxCore\CPT\Shortcodes\ProductListSimple;
...
class ProductListSimple implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product List - Simple', 'playerx' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						array(
							...
							'value'      => array(
								esc_html__( 'Sale', 'playerx' )         => 'sale',
								esc_html__( 'Best Sellers', 'playerx' ) => 'best-sellers',
								esc_html__( 'Featured', 'playerx' )     => 'featured'
							),
							'save_always' => true
						),
						array(
	...
	public function render( $atts, $content = null ) {
		...
		$html = playerx_edge_get_woo_shortcode_module_template_part( 'templates/product-list-template', 'product-list-simple', '', $params );

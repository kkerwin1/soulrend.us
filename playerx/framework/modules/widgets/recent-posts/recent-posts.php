...
class PlayerxEdgeClassRecentPosts extends PlayerxEdgeClassWidget {
	public function __construct() {
		parent::__construct(
			'edgtf_recent_posts',
			esc_html__( 'Playerx Recent Posts', 'playerx' ),
			array( 'description' => esc_html__( 'Select recent posts that you would like to display', 'playerx' ) )
		);
	...
	public function widget( $args, $instance ) {
        ...
        if ( $query->have_posts() ) {
            ...
            $html .= esc_html__('Sorry, there are no posts matching your criteria', 'playerx');
        }

...
<?php } else {
	...
	$label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'playerx' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'playerx' );
	?>
    <div class="edgtf-quantity-buttons quantity">
        ...
        <input type="text"
                ...
                title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'playerx' ) ?>"
                size="4"
